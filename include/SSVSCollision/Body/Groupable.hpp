...
public:
    ...
    template <typename... TGroups>
    inline void addGroupsNoResolve(Group mGroup, TGroups... mGroups) noexcept
    {
        addGroupsNoResolve(mGroup);
        addGroupsNoResolve(mGroups...);
    }
    template <typename... TGroups>
    inline void delGroupsNoResolve(Group mGroup, TGroups... mGroups) noexcept
    {
    ...
    inline bool hasAnyGroupToCheck(const GroupBitset& mGroups) const noexcept
    {
        return (groupsToCheck & mGroups).any();
    }
    inline bool hasAnyGroupNoResolve(const GroupBitset& mGroups) const noexcept
    {
    ...
    inline bool hasAllGroupsToCheck(const GroupBitset& mGroups) const noexcept
    {
        return (groupsToCheck & mGroups).all();
    }
    inline bool hasAllGroupsNoResolve(const GroupBitset& mGroups) const noexcept
    {
