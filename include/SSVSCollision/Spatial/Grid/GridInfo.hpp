...
private:
    ...
    int startX{0}, startY{0}, endX{0}, endY{0}, oldStartX{-1}, oldStartY{-1},
    oldEndX{-1}, oldEndY{-1}, spatialPaint{-1};
    bool invalid{true};
    ...
    inline void handleCollisionImpl(FT mFT, BodyType* mBody, SensorTag) const
    noexcept
    {
        SSVU_ASSERT(mBody != nullptr);
...
public:
    inline GridInfo(SpatialType& mGrid, BaseType& mBase) noexcept : grid(mGrid),
                                                                    base(mBase)
    {
    }
